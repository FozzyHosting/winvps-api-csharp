...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineUserDefinition :  IEquatable<MachineUserDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineUserDefinition" /> class.
        /// </summary>
        /// <param name="username">username.</param>
        /// <param name="role">role.</param>
        /// <param name="password">password.</param>
        public MachineUserDefinition(string username = default(string), string role = default(string), string password = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineUserDefinition {\n");
        ...
        {
            return this.Equals(input as MachineUserDefinition);
        }

        /// <summary>
        /// Returns true if MachineUserDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineUserDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineUserDefinition input)
        {
            if (input == null)
                return false;
