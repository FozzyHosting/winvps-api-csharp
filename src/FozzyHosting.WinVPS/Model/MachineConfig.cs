...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineConfig :  IEquatable<MachineConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineConfig" /> class.
        /// </summary>
        ...
        public MachineConfig(int? bandwidth = default(int?), int? cpuCores = default(int?), int? cpuPercent = default(int?), int? diskSize = default(int?), int? ramMin = default(int?), int? ramMax = default(int?))
        {
        ...
        {
            return this.Equals(input as MachineConfig);
        }

        /// <summary>
        /// Returns true if MachineConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineConfig input)
        {
            if (input == null)
                return false;
