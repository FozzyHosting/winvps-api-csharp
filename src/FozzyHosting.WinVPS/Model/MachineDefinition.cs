...
namespace FozzyHosting.WinVPS.Model
{
        ...
        public partial class MachineDefinition :  IEquatable<MachineDefinition>, IValidatableObject
    {
        ...
        public MachineDefinition(string name = default(string), string status = default(string), List<IpDefinition> ips = default(List<IpDefinition>), MachineOS os = default(MachineOS), MachineConfig config = default(MachineConfig))
        {
            this.Name = name;
            this.Status = status;
            this.Ips = ips;
