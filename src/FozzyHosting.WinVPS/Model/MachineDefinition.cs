...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineDefinition :  IEquatable<MachineDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineDefinition" /> class.
        /// </summary>
        /// <param name="name">Machine name and primary Key..</param>
        /// <param name="status">Current machine status..</param>
        /// <param name="notes">Machine notes..</param>
        /// <param name="ips">List of IPs assegned to the Machine..</param>
        /// <param name="os">os.</param>
        /// <param name="config">config.</param>
        public MachineDefinition(string name = default(string), string status = default(string), string notes = default(string), List<IpDefinition> ips = default(List<IpDefinition>), MachineOS os = default(MachineOS), MachineConfig config = default(MachineConfig))
        {
            this.Name = name;
            this.Status = status;
            this.Notes = notes;
        ...
        /// </summary>
        /// <value>Machine name and primary Key.</value>
        ...
        /// </summary>
        /// <value>Current machine status.</value>
        ...
        /// </summary>
        /// <value>List of IPs assegned to the Machine.</value>
        [DataMember(Name="ips", EmitDefaultValue=false)]
        public List<IpDefinition> Ips { get; set; }

        /// <summary>
        /// Gets or Sets Os
        /// </summary>
        [DataMember(Name="os", EmitDefaultValue=false)]
        public MachineOS Os { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineDefinition {\n");
        ...
        {
            return this.Equals(input as MachineDefinition);
        }

        /// <summary>
        /// Returns true if MachineDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineDefinition input)
        {
            if (input == null)
                return false;
