...
{
    /// <summary>
    /// MachineAddIpResponseData
    /// </summary>
    [DataContract]
        public partial class MachineAddIpResponseData :  IEquatable<MachineAddIpResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineAddIpResponseData" /> class.
        /// </summary>
        /// <param name="address">address.</param>
        /// <param name="jobs">jobs.</param>
        public MachineAddIpResponseData(string address = default(string), List<JobDefinition> jobs = default(List<JobDefinition>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineAddIpResponseData {\n");
        ...
        {
            return this.Equals(input as MachineAddIpResponseData);
        }

        /// <summary>
        /// Returns true if MachineAddIpResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineAddIpResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineAddIpResponseData input)
        {
            if (input == null)
                return false;
