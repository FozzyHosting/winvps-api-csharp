...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineCommandResultResponse :  IEquatable<MachineCommandResultResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineCommandResultResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MachineCommandResultResponse(MachineCommandResultResponseData data = default(MachineCommandResultResponseData))
        {
            this.Data = data;
        }
        ...
        public MachineCommandResultResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineCommandResultResponse {\n");
        ...
        {
            return this.Equals(input as MachineCommandResultResponse);
        }

        /// <summary>
        /// Returns true if MachineCommandResultResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineCommandResultResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineCommandResultResponse input)
        {
            if (input == null)
                return false;
