...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BrandsList : List<BrandDefinition>,  IEquatable<BrandsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandsList" /> class.
        /// </summary>
        public BrandsList() : base()
        {
        }
        ...
        {
            return this.Equals(input as BrandsList);
        }

        /// <summary>
        /// Returns true if BrandsList instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandsList input)
        {
            if (input == null)
                return false;
