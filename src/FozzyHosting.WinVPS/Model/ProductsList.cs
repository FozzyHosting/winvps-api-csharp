...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductsList : List<ProductDefinition>,  IEquatable<ProductsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductsList" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProductsList);
        }

        /// <summary>
        /// Returns true if ProductsList instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductsList input)
        {
            if (input == null)
                return false;
