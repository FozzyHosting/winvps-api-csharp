...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LocationsList : List<LocationDefinition>,  IEquatable<LocationsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationsList" /> class.
        /// </summary>
        public LocationsList() : base()
        {
        }
        ...
        {
            return this.Equals(input as LocationsList);
        }

        /// <summary>
        /// Returns true if LocationsList instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationsList input)
        {
            if (input == null)
                return false;
