...
{
    /// <summary>
    /// MachineCreateResponseData
    /// </summary>
    [DataContract]
        public partial class MachineCreateResponseData :  IEquatable<MachineCreateResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineCreateResponseData" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="jobs">jobs.</param>
        public MachineCreateResponseData(string name = default(string), List<JobDefinition> jobs = default(List<JobDefinition>))
        {
            this.Name = name;
            this.Jobs = jobs;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineCreateResponseData {\n");
        ...
        {
            return this.Equals(input as MachineCreateResponseData);
        }

        /// <summary>
        /// Returns true if MachineCreateResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineCreateResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineCreateResponseData input)
        {
            if (input == null)
                return false;
