...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineEditableFields :  IEquatable<MachineEditableFields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineEditableFields" /> class.
        /// </summary>
        /// <param name="password">The main machine password used for Administrator user..</param>
        /// <param name="productId">Primary Product ID..</param>
        public MachineEditableFields(string password = default(string), int? productId = default(int?))
        {
        ...
        /// <summary>
        /// The main machine password used for Administrator user.
        /// </summary>
        /// <value>The main machine password used for Administrator user.</value>
        ...
        /// Primary Product ID.
        /// </summary>
        /// <value>Primary Product ID.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineEditableFields {\n");
        ...
        {
            return this.Equals(input as MachineEditableFields);
        }

        /// <summary>
        /// Returns true if MachineEditableFields instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineEditableFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineEditableFields input)
        {
            if (input == null)
                return false;
