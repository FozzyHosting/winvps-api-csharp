...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineUsersListResponse :  IEquatable<MachineUsersListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineUsersListResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public MachineUsersListResponse(MachineUsersList data = default(MachineUsersList), PaginationDetails pagination = default(PaginationDetails))
        {
            this.Data = data;
        ...
        public MachineUsersList Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineUsersListResponse {\n");
        ...
        {
            return this.Equals(input as MachineUsersListResponse);
        }

        /// <summary>
        /// Returns true if MachineUsersListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineUsersListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineUsersListResponse input)
        {
            if (input == null)
                return false;
