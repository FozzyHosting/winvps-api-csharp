...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BrandDefinition :  IEquatable<BrandDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandDefinition" /> class.
        /// </summary>
        /// <param name="id">Brand primary ID. Used on machine creation.</param>
        /// <param name="name">Brand name.</param>
        public BrandDefinition(int? id = default(int?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        /// </summary>
        /// <value>Brand primary ID. Used on machine creation</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BrandDefinition {\n");
        ...
        {
            return this.Equals(input as BrandDefinition);
        }

        /// <summary>
        /// Returns true if BrandDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandDefinition input)
        {
            if (input == null)
                return false;
