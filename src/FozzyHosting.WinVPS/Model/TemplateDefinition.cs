...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TemplateDefinition :  IEquatable<TemplateDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateDefinition" /> class.
        /// </summary>
        /// <param name="id">Template primary ID. Used on machine creation.</param>
        /// <param name="name">Template name includes OS version.</param>
        public TemplateDefinition(int? id = default(int?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        /// </summary>
        /// <value>Template primary ID. Used on machine creation</value>
        ...
        /// </summary>
        /// <value>Template name includes OS version</value>
        ...
        {
            return this.Equals(input as TemplateDefinition);
        }

        /// <summary>
        /// Returns true if TemplateDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateDefinition input)
        {
            if (input == null)
                return false;
