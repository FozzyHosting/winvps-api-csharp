...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LocationDefinition :  IEquatable<LocationDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationDefinition" /> class.
        /// </summary>
        /// <param name="id">Location primary ID. Used on machine creation.</param>
        /// <param name="name">Location name. Can includes country, city, data center name, etc..</param>
        public LocationDefinition(int? id = default(int?), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        /// </summary>
        /// <value>Location primary ID. Used on machine creation</value>
        ...
        /// </summary>
        /// <value>Location name. Can includes country, city, data center name, etc.</value>
        ...
        {
            return this.Equals(input as LocationDefinition);
        }

        /// <summary>
        /// Returns true if LocationDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationDefinition input)
        {
            if (input == null)
                return false;
