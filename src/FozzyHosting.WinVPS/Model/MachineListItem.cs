...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineListItem :  IEquatable<MachineListItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineListItem" /> class.
        /// </summary>
        ...
        public MachineListItem(string name = default(string), string status = default(string), string notes = default(string))
        {
            this.Name = name;
            this.Status = status;
            this.Notes = notes;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineListItem {\n");
        ...
        {
            return this.Equals(input as MachineListItem);
        }

        /// <summary>
        /// Returns true if MachineListItem instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineListItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineListItem input)
        {
            if (input == null)
                return false;
