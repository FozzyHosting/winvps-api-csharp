...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineReinstallableFields :  IEquatable<MachineReinstallableFields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineReinstallableFields" /> class.
        /// </summary>
        /// <param name="templateId">Primary Template ID..</param>
        /// <param name="brandId">Primary Brand ID..</param>
        public MachineReinstallableFields(int? templateId = default(int?), int? brandId = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineReinstallableFields {\n");
        ...
        {
            return this.Equals(input as MachineReinstallableFields);
        }

        /// <summary>
        /// Returns true if MachineReinstallableFields instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineReinstallableFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineReinstallableFields input)
        {
            if (input == null)
                return false;
