...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IpDefinition :  IEquatable<IpDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IpDefinition" /> class.
        /// </summary>
        /// <param name="version">IP version. 4 or 6.</param>
        /// <param name="address">IP address.</param>
        public IpDefinition(int? version = default(int?), string address = default(string))
        {
        ...
        {
            return this.Equals(input as IpDefinition);
        }

        /// <summary>
        /// Returns true if IpDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of IpDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IpDefinition input)
        {
            if (input == null)
                return false;
