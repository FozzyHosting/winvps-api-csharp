...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class JobsListResponse :  IEquatable<JobsListResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public JobsListResponse(JobsList data = default(JobsList), PaginationDetails pagination = default(PaginationDetails))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as JobsListResponse);
        }

        /// <summary>
        /// Returns true if JobsListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of JobsListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobsListResponse input)
        {
            if (input == null)
                return false;
