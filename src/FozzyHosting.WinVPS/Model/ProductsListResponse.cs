...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductsListResponse :  IEquatable<ProductsListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductsListResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public ProductsListResponse(ProductsList data = default(ProductsList), PaginationDetails pagination = default(PaginationDetails))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as ProductsListResponse);
        }

        /// <summary>
        /// Returns true if ProductsListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductsListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductsListResponse input)
        {
            if (input == null)
                return false;
