...
{
    /// <summary>
    /// MachineCommandResultResponseData
    /// </summary>
    [DataContract]
        public partial class MachineCommandResultResponseData :  IEquatable<MachineCommandResultResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineCommandResultResponseData" /> class.
        /// </summary>
        /// <param name="jobs">jobs.</param>
        public MachineCommandResultResponseData(List<JobDefinition> jobs = default(List<JobDefinition>))
        {
            this.Jobs = jobs;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineCommandResultResponseData {\n");
        ...
        {
            return this.Equals(input as MachineCommandResultResponseData);
        }

        /// <summary>
        /// Returns true if MachineCommandResultResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineCommandResultResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineCommandResultResponseData input)
        {
            if (input == null)
                return false;
