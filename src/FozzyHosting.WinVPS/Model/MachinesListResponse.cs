...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachinesListResponse :  IEquatable<MachinesListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachinesListResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public MachinesListResponse(MachinesList data = default(MachinesList), PaginationDetails pagination = default(PaginationDetails))
        {
            this.Data = data;
        ...
        public MachinesList Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachinesListResponse {\n");
        ...
        {
            return this.Equals(input as MachinesListResponse);
        }

        /// <summary>
        /// Returns true if MachinesListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MachinesListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachinesListResponse input)
        {
            if (input == null)
                return false;
