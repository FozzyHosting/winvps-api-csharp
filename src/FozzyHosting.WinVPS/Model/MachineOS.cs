...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineOS :  IEquatable<MachineOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineOS" /> class.
        /// </summary>
        /// <param name="templateId">templateId.</param>
        /// <param name="brandId">brandId.</param>
        /// <param name="updateStatus">updateStatus.</param>
        public MachineOS(int? templateId = default(int?), int? brandId = default(int?), MachineOSUpdateStatus updateStatus = default(MachineOSUpdateStatus))
        {
        ...
        public MachineOSUpdateStatus UpdateStatus { get; set; }
        ...
        {
            return this.Equals(input as MachineOS);
        }

        /// <summary>
        /// Returns true if MachineOS instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineOS input)
        {
            if (input == null)
                return false;
