...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineNonReinstallableFields :  IEquatable<MachineNonReinstallableFields>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineNonReinstallableFields" /> class.
        /// </summary>
        /// <param name="diskType">Server disk type. HDD or SSD..</param>
        /// <param name="locationId">Primary Location ID..</param>
        public MachineNonReinstallableFields(DiskTypeEnum? diskType = default(DiskTypeEnum?), int? locationId = default(int?))
        {
        ...
        {
            return this.Equals(input as MachineNonReinstallableFields);
        }

        /// <summary>
        /// Returns true if MachineNonReinstallableFields instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineNonReinstallableFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineNonReinstallableFields input)
        {
            if (input == null)
                return false;
