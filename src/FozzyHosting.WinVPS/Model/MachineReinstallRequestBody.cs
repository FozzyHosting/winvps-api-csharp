...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineReinstallRequestBody : MachineReinstallableFields,  IEquatable<MachineReinstallRequestBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineReinstallRequestBody" /> class.
        /// </summary>
        /// <param name="autoStart">autoStart.</param>
        /// <param name="password">password.</param>
        public MachineReinstallRequestBody(int? autoStart = default(int?), string password = default(string), int? templateId = default(int?), int? brandId = default(int?)) : base(templateId, brandId)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineReinstallRequestBody {\n");
        ...
        {
            return this.Equals(input as MachineReinstallRequestBody);
        }

        /// <summary>
        /// Returns true if MachineReinstallRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineReinstallRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineReinstallRequestBody input)
        {
            if (input == null)
                return false;
