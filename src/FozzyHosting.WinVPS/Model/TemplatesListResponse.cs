...
namespace FozzyHosting.WinVPS.Model
{
        ...
        public partial class TemplatesListResponse :  IEquatable<TemplatesListResponse>, IValidatableObject
    {
        ...
        public TemplatesListResponse(TemplatesList data = default(TemplatesList), PaginationDetails pagination = default(PaginationDetails))
        {
            this.Data = data;
        ...
        public TemplatesList Data { get; set; }
