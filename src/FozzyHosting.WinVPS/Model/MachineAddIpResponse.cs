...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineAddIpResponse :  IEquatable<MachineAddIpResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineAddIpResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MachineAddIpResponse(MachineAddIpResponseData data = default(MachineAddIpResponseData))
        {
            this.Data = data;
        }
        ...
        public MachineAddIpResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineAddIpResponse {\n");
        ...
        {
            return this.Equals(input as MachineAddIpResponse);
        }

        /// <summary>
        /// Returns true if MachineAddIpResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineAddIpResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineAddIpResponse input)
        {
            if (input == null)
                return false;
