...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineDetailsResponse :  IEquatable<MachineDetailsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineDetailsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MachineDetailsResponse(MachineDefinition data = default(MachineDefinition))
        {
            this.Data = data;
        }
        ...
        public MachineDefinition Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineDetailsResponse {\n");
        ...
        {
            return this.Equals(input as MachineDetailsResponse);
        }

        /// <summary>
        /// Returns true if MachineDetailsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineDetailsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineDetailsResponse input)
        {
            if (input == null)
                return false;
