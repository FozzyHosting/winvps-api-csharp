...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BrandsListResponse :  IEquatable<BrandsListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandsListResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public BrandsListResponse(BrandsList data = default(BrandsList), PaginationDetails pagination = default(PaginationDetails))
        {
            this.Data = data;
        ...
        public BrandsList Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BrandsListResponse {\n");
        ...
        {
            return this.Equals(input as BrandsListResponse);
        }

        /// <summary>
        /// Returns true if BrandsListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandsListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandsListResponse input)
        {
            if (input == null)
                return false;
