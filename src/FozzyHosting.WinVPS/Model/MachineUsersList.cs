...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineUsersList : List<MachineUserDefinition>,  IEquatable<MachineUsersList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineUsersList" /> class.
        /// </summary>
        public MachineUsersList() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineUsersList {\n");
        ...
        {
            return this.Equals(input as MachineUsersList);
        }

        /// <summary>
        /// Returns true if MachineUsersList instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineUsersList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineUsersList input)
        {
            if (input == null)
                return false;
