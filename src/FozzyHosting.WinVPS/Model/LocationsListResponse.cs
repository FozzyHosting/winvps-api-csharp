...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LocationsListResponse :  IEquatable<LocationsListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationsListResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public LocationsListResponse(LocationsList data = default(LocationsList), PaginationDetails pagination = default(PaginationDetails))
        {
            this.Data = data;
        ...
        public LocationsList Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocationsListResponse {\n");
        ...
        {
            return this.Equals(input as LocationsListResponse);
        }

        /// <summary>
        /// Returns true if LocationsListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationsListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationsListResponse input)
        {
            if (input == null)
                return false;
