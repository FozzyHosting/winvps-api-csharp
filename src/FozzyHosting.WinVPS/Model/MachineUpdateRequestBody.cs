...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineUpdateRequestBody : MachineEditableFields,  IEquatable<MachineUpdateRequestBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineUpdateRequestBody" /> class.
        /// </summary>
        ...
        public MachineUpdateRequestBody(int? addDisk = default(int?), int? addRam = default(int?), int? addCpu = default(int?), int? addBand = default(int?), string password = default(string), int? productId = default(int?)) : base(password, productId)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineUpdateRequestBody {\n");
        ...
        {
            return this.Equals(input as MachineUpdateRequestBody);
        }

        /// <summary>
        /// Returns true if MachineUpdateRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineUpdateRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineUpdateRequestBody input)
        {
            if (input == null)
                return false;
