...
namespace FozzyHosting.WinVPS.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TemplatesList : List<TemplateDefinition>,  IEquatable<TemplatesList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplatesList" /> class.
        /// </summary>
        public TemplatesList() : base()
        {
        }
        ...
        {
            return this.Equals(input as TemplatesList);
        }

        /// <summary>
        /// Returns true if TemplatesList instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplatesList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplatesList input)
        {
            if (input == null)
                return false;
