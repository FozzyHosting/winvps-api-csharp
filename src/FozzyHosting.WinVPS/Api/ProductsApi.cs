...
namespace FozzyHosting.WinVPS.Api
{
        ...
        public interface IProductsApi : IApiAccessor
    {
        ...
        /// <returns>ProductsListResponse</returns>
        ...
        /// </remarks>
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ProductsListResponse</returns>
        ApiResponse<ProductsListResponse> ProductsGetWithHttpInfo ();
        ...
        /// </remarks>
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ProductsListResponse</returns>
        System.Threading.Tasks.Task<ProductsListResponse> ProductsGetAsync ();
        ...
        /// </remarks>
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (ProductsListResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ProductsListResponse>> ProductsGetAsyncWithHttpInfo ();
        ...
        public partial class ProductsApi : IProductsApi
    {
        ...
        /// <returns></returns>
        public ProductsApi(FozzyHosting.WinVPS.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ProductsListResponse</returns>
        public ProductsListResponse ProductsGet ()
        {
             ApiResponse<ProductsListResponse> localVarResponse = ProductsGetWithHttpInfo();
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ProductsListResponse</returns>
        public ApiResponse< ProductsListResponse > ProductsGetWithHttpInfo ()
        {
            ...
            return new ApiResponse<ProductsListResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ProductsListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ProductsListResponse)));
        }
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ProductsListResponse</returns>
        public async System.Threading.Tasks.Task<ProductsListResponse> ProductsGetAsync ()
        {
             ApiResponse<ProductsListResponse> localVarResponse = await ProductsGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (ProductsListResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ProductsListResponse>> ProductsGetAsyncWithHttpInfo ()
        {
