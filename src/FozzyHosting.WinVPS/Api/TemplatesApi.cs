...
namespace FozzyHosting.WinVPS.Api
{
        ...
        public interface ITemplatesApi : IApiAccessor
    {
        ...
        ApiResponse<TemplatesListResponse> TemplatesGetWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<TemplatesListResponse> TemplatesGetAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<TemplatesListResponse>> TemplatesGetAsyncWithHttpInfo ();
        ...
        public partial class TemplatesApi : ITemplatesApi
    {
        ...
        /// <returns></returns>
        public TemplatesApi(FozzyHosting.WinVPS.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>TemplatesListResponse</returns>
        public TemplatesListResponse TemplatesGet ()
        {
             ApiResponse<TemplatesListResponse> localVarResponse = TemplatesGetWithHttpInfo();
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of TemplatesListResponse</returns>
        public ApiResponse< TemplatesListResponse > TemplatesGetWithHttpInfo ()
        {
            ...
            return new ApiResponse<TemplatesListResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (TemplatesListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(TemplatesListResponse)));
        }
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of TemplatesListResponse</returns>
        public async System.Threading.Tasks.Task<TemplatesListResponse> TemplatesGetAsync ()
        {
             ApiResponse<TemplatesListResponse> localVarResponse = await TemplatesGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (TemplatesListResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TemplatesListResponse>> TemplatesGetAsyncWithHttpInfo ()
        {
