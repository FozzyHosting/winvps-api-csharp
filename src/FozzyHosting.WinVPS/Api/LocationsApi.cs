...
namespace FozzyHosting.WinVPS.Api
{
        ...
        public interface ILocationsApi : IApiAccessor
    {
        ...
        /// <returns>LocationsListResponse</returns>
        ...
        /// </remarks>
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of LocationsListResponse</returns>
        ApiResponse<LocationsListResponse> LocationsGetWithHttpInfo ();
        ...
        /// </remarks>
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of LocationsListResponse</returns>
        System.Threading.Tasks.Task<LocationsListResponse> LocationsGetAsync ();
        ...
        /// </remarks>
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (LocationsListResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<LocationsListResponse>> LocationsGetAsyncWithHttpInfo ();
        ...
        public partial class LocationsApi : ILocationsApi
    {
        ...
        /// <returns></returns>
        public LocationsApi(FozzyHosting.WinVPS.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>LocationsListResponse</returns>
        public LocationsListResponse LocationsGet ()
        {
             ApiResponse<LocationsListResponse> localVarResponse = LocationsGetWithHttpInfo();
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of LocationsListResponse</returns>
        public ApiResponse< LocationsListResponse > LocationsGetWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("LocationsGet", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<LocationsListResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (LocationsListResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(LocationsListResponse)));
        }
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of LocationsListResponse</returns>
        public async System.Threading.Tasks.Task<LocationsListResponse> LocationsGetAsync ()
        {
             ApiResponse<LocationsListResponse> localVarResponse = await LocationsGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="FozzyHosting.WinVPS.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (LocationsListResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LocationsListResponse>> LocationsGetAsyncWithHttpInfo ()
        {
