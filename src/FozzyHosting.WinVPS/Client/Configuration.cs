...
namespace FozzyHosting.WinVPS.Client
{
        ...
        public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/0.0.0/csharp";
            BasePath = "https://winvps.fozzy.com/api/v2";
        ...
        public Configuration(
            ...
            string basePath = "https://winvps.fozzy.com/api/v2") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/0.0.0/csharp"
        ...
        {
            String report = "C# SDK (FozzyHosting.WinVPS) Debug Report:\n";
