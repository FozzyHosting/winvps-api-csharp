...
${nuget_cmd} install src/FozzyHosting.WinVPS/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/FozzyHosting.WinVPS.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/FozzyHosting.WinVPS.dll \
-recurse:'src/FozzyHosting.WinVPS/*.cs' \
-doc:bin/FozzyHosting.WinVPS.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/FozzyHosting.WinVPS.dll was created successfully"
fi
